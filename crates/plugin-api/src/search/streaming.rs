...
mod tests {
    ...
    impl SearchPluginDataset for NullDataset {
        ...
        fn build_table<'a>(&self, _context: crate::TableContext<'a>) -> crate::TableDescriptor<'a> {
            crate::TableDescriptor::new(Vec::new(), Vec::new(), Vec::new())
        }
    }
    ...
    fn mode() -> crate::SearchMode {
        crate::SearchMode::from_descriptor(&DESCRIPTOR)
    }
